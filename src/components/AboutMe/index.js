...
export function AboutMe() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-start py-8 sm:py-16 md:py-36 gap-10 sm:gap-16">
      <div className="h-auto flex flex-col gap-4 sm:gap-8">
      ...
      <div className="flex w-full items-start">
        <div className="flex flex-col gap-4 sm:gap-8">
          ...
          <div className="flex gap-2 sm:gap-4 w-full flex-wrap justify-between md:justify-start">
            <img
            ...
            />
            <img
              className="h-10 w-10 lg:h-12 lg:w-12 saturate-[120%]"
              alt="html"
